<?php
/*
Modified by Muhammad Umair on 9/11/2015 to add more configuration under shelf
...
class ezTweet {
    ...
    private $consumer_key = 'SVjkC9TybMWCqSf2ct0Dzw';//<< Change it

    // Your Twitter App Consumer Secret
    private $consumer_secret = '0oyIA1uknRwBTZEinW1lsISGy1j0ZLkPJ2VDuBMNS4';//<< Change it

    // Your Twitter App Access Token
    private $user_token = '792356948-YFAFBLPK2jStMxucy5Px6IBWIEofdop3cOJmBPGE';//<< Change it

    // Your Twitter App Access Token Secret
    private $user_secret = 'nFvSZx0quGcIfowZWsixNBSCsKROpaASWeXpx7IAuE';//<< Change it

    //Host of API
    private $host = 'api.twitter.com'; 

    //Host of API
    private $url = '/1.1/statuses/user_timeline.json'; 

    //Account name
    private $account = "JohnMBarrows"; 

    //include rts
    private $include_rts = 1; 
    //include entities
    private $include_entities = 1; 
    ...
    private function getParameters() {
        ...
        $parameters['screen_name'][] = "JohnMBarrows";
